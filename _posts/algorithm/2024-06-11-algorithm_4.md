...
excerpt: "그래프 탐색의 기본 DFS(깊이우선탐색)와 BFS(너비우선탐색)의 개념과 파이썬 구현 방법입니다."
layout: single
categories:
    - algorithm
tags:
...
![간선노드-removebg-preview]({{site.url}}/images/algorithm/2024-06-11-algorithm_4/간선노드-removebg-preview-1718092401498-6.png){: .align-center}
...
![간선노드_2-removebg-preview]({{site.url}}/images/algorithm/2024-06-11-algorithm_4/간선노드_2-removebg-preview.png){: .align-center}

위와 같은 그래프가 있다고 가정.

#### 1. **인접 행렬**   : 2차원 배열로 그래프의 연결 관계를 표현하는 방식 

![인접행렬]({{site.url}}/images/algorithm/2024-06-11-algorithm_4/인접행렬.jpg)
...
![인접리스트-removebg-preview]({{site.url}}/images/algorithm/2024-06-11-algorithm_4/인접리스트-removebg-preview.png)
